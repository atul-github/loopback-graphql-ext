...
function createModelType(m) {
  ...
  typeDef += ' find(where:' + m.modelName + 'Filter) : [' + m.modelName + '] \n';
...
function createFieldFilter(m) {
  var typeDef = 'input ' + m.modelName + 'Filter { \n';
  //console.log(m);

  var inqFilter = 'input inq' + m.modelName + 'Filter { \n';
  ...
  typeDef += ' and : [' + m.modelName + 'Filter] \n';
  typeDef += ' or : [' + m.modelName + 'Filter] \n';
  typeDef += ' gt : ' + m.modelName + 'Filter \n';
  typeDef += ' gte : ' + m.modelName + 'Filter \n';
  typeDef += ' lt : ' + m.modelName + 'Filter \n';
  typeDef += ' lte : ' + m.modelName + 'Filter \n';
  typeDef += ' inq : inq' + m.modelName + 'Filter \n';
  typeDef += ' nin : nin' + m.modelName + 'Filter \n';
  typeDef += ' } \n\n';
...
function createSchema(app) {
  ...
  Object.keys(app.models).map((m, index) => {
    ...
    modelTypeDef = createFieldFilter(model);
    schemaString += modelTypeDef;
